...
from probability import joint, p_independent
from information import entropy, joint_entropy, mutual_information
from information import mutual_information2
